...
function Page() {
  return (
    <div className="flex flex-col items-center gap-10 pt-24">
      ...
      <div className="flex flex-col gap-16 mt-16">
        ...
        <div>
          ...
          <ul className="ul-li-style leading-9 max-w-[40rem]">
            ...
            <li>음악 목록 출력</li>
            <li>커스텀 프로그레스바</li>
            <span>시간이 흐름에 따라 바가 움직이고 특정 위치 클릭 시 해당 시간으로 이동</span>
            <li>반응형</li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex flex-col  gap-10 leading-8 max-w-[65rem]">
        <div>
          <h2>🔎 동기 및 효과</h2>
          <br />
          <p className=" pl-[3rem]  leading-9">
            ...
            기능과
            <b>requestAnimationFrame</b> 사용법을 숙지할 수 있었다.
          </p>
        </div>
        <br />
        {/* <div>
        ...
        <br />
        <div className="flex flex-col gap-4 text-left leading-9">
          <h2 className="mb-10 text-center">🔧 트러블 슈팅 </h2>
          <h3 className="text-center">
            popUp 메뉴(이퀄라이저, 플레이리스트)가 tap 키 눌렀을 때 밖으로 빠져나오는 현상 ✅
          </h3>
          <p className="pl-6">
            ...
            <br />
            <br />
            <h3 className="text-center text-blue-600">Solution 1</h3>
            <span className="text-blue-800">
              따라서 useEffect와 타이머를 이용해 popIn(메뉴 닫기) 시 0.2초 뒤 visibility: hidden
              되게 만들어 부드럽게 transition 되어 사라지는 효과는 보여지고, 다 사라졌을 시
              hidden되어 탭키 포커스에 잡히지 않게 만들었다.
            </span>
            <br />
            <br />
            ...
            <br />
            <br />
            <h3 className="text-center text-blue-600">Solution 2</h3>
            <span className="text-blue-800">
              이번엔 검색을 통해 요소의 출력은 유지하면서 비활성화하며 상속도 되는 inert 속성을 알게
              되었고 사용해 보았다. 억지로도(tab키를 연타 하는 식) 포커스에 잡히지 않거나 잡혀도
              UI가 밀려나지 않는 것을 확인하고 수정해주었다. inert 속성의 경우 2023년 최신 기능이라
              폴리필을 다운받아 적용해주었다.
            </span>
          ...
          <br />
          <h3 className="text-center">
            방금 추가한 음악을 삭제후 동일한 음악을 다시 추가했을 시 추가되지 않는 문제 ✅
          </h3>
          <p className="pl-6">
            <h3 className="text-center text-blue-600">Solution</h3>
            <span className="text-blue-800">
          ...
          <br />
          <br />
          <h3 className="text-center">오디오 컨텍스트가 사용자와 상호작용 전에 생성되는 문제 ✅</h3>
          <p className="pl-6">
            <h3 className="text-center text-blue-600">Solution</h3>
            <span className="text-blue-800">
